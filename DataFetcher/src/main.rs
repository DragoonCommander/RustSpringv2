...
// --- Trait Definition ---
trait Pricing {
    // Fetches the latest price for the asset
    fn fetch_price(&mut self) -> Result<(), String>;
    
    // Prints the fetched price to the terminal
    fn print_price(&self);
}

// --- Struct Definitions for Assets ---
struct Bitcoin {
    price: f64, // Price of Bitcoin
}

struct Ethereum {
    price: f64, // Price of Ethereum
}

struct SP500 {
    price: f64, // Price of S&P 500
}
...
#[derive(Deserialize, Debug)]
struct CurrencyData {
    usd: f64, // USD price of the currency
}
...
#[derive(Deserialize, Debug)]
struct YahooMeta {
    regularMarketPrice: f64, // Regular market price of the S&P 500
}
...
impl Pricing for Bitcoin {
    ...
    fn print_price(&self) {
        // Print the Bitcoin price to the terminal
...
impl Pricing for Ethereum {
    ...
    fn print_price(&self) {
        // Print the Ethereum price to the terminal
